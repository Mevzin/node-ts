...
export class Default1710340920913 implements MigrationInterface {
    name = 'Default1710340920913'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "subjecs" ("id" SERIAL NOT NULL, "name" text NOT NULL, CONSTRAINT "PK_904c527eb54c8f16ce8c3791dae" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "room_subject" ADD CONSTRAINT "FK_f227421d2ef64ab086261ac07fd" FOREIGN KEY ("room_id") REFERENCES "subjecs"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "subjecs"`);
    }
